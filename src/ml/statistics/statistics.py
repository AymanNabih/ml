...
def mode(data, weights=None):
    ...
    weights : flat list or 1D-array, optional
        Weights for the data. It must be an array with the same size of the
        data. weights[i] measures the contribution of data[i]. When weights
        are not specified, it's assumed that weights[i] == 1 for all i.
